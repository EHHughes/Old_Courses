def phase_sketch(f, x_limits, y_limits, num_curves, show, plt_xlim, plt_ylim):
    ...
    w1 = matplotlib.patches.Wedge((0,0), 0.05, -90, 90, edgecolor = 'black', facecolor = 'None', zorder = 3)
    w2 = matplotlib.patches.Wedge((0,0), 0.05, 90, -90, color = 'black', zorder = 3)
    ax.add_patch(w1)
    ax.add_patch(w2)
    if show == 1:
        plt.show()  
